...
|-----|-------------|----------|------|
| [**app-arm64-v8a-release.apk**]([https://github.com/techjarves/Uncensored-Local-AI-Multiplatform/releases/download/v2.0.0/app-arm64-v8a-release.apk](https://github.com/Sahil-Kadam88/Aurora/releases/download/v1.0.0/app-arm64-v8a-release.apk)) | ARM 64-bit | **Most phones (2018+)** | ~65 MB |
