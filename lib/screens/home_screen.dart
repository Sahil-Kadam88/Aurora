...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildMobileLayout() {
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          color: context.bgPanel.withValues(alpha: 0.85),
        ...
        child: NavigationBar(
          ...
          destinations: [
            NavigationDestination(
              icon: Icon(Icons.chat_outlined, color: context.textD),
              selectedIcon: Icon(
                Icons.chat_rounded,
                color: AppColors.neonCyan,
                shadows: [
                  Shadow(color: AppColors.neonCyan.withValues(alpha: 0.5), blurRadius: 12),
                ],
              ),
              label: 'Chat',
            ),
            NavigationDestination(
              icon: Icon(Icons.widgets_outlined, color: context.textD),
              selectedIcon: Icon(
            ...
            NavigationDestination(
              icon: Icon(Icons.settings_outlined, color: context.textD),
              selectedIcon: Icon(
    ...
    return Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppColors.accent.withValues(alpha: context.isDark ? 0.06 : 0.03),
              blurRadius: 12,
              offset: const Offset(0, 2),
            ),
            BoxShadow(
  ...
  Widget _circleButton({
    ...
    final isStop = icon == Icons.stop_rounded;
    return Tooltip(
      message: tooltip,
      child: InkWell(
        onTap: onTap,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: isStop
                ? const LinearGradient(colors: [AppColors.red, Color(0xFFFF6B8A)])
                : AppColors.accentGradient,
            shape: BoxShape.circle,
            boxShadow: [
              BoxShadow(
                color: (isStop ? AppColors.red : AppColors.accent).withValues(alpha: 0.35),
                blurRadius: 10,
                spreadRadius: 0,
              ),
            ],
