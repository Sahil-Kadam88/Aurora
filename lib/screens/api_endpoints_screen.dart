          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: running ? AppColors.green.withValues(alpha: 0.08) : AppColors.red.withValues(alpha: 0.08),
                border: Border.all(
                  color: running ? AppColors.green.withValues(alpha: 0.25) : AppColors.red.withValues(alpha: 0.25),
                ),
                borderRadius: BorderRadius.circular(16),
                boxShadow: [
                  BoxShadow(
                    color: (running ? AppColors.green : AppColors.red).withValues(alpha: 0.08),
                    blurRadius: 12,
                  ),
                ],
              ),
